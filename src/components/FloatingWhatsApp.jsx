export default function FloatingWhatsApp() {
    return (
        <div className="fixed bottom-6 right-6 z-30 flex items-center gap-3 group">
            {/* Tooltip */}
            <span className="bg-[#111] text-white px-3.5 py-2 text-[11px] font-bold uppercase tracking-wider whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 -translate-x-2 group-hover:translate-x-0 shadow-lg pointer-events-none border border-white/10">
            ...
            <div className="relative">
                {/* Pulse rings */}
                <span className="absolute inset-0 rounded-none bg-[#25D366] animate-[pulse-ring_2s_ease-out_infinite] opacity-0" />
