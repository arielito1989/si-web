        ...
        <>
            ...
            >
                ...
                <div className="px-8 pb-10 border-t border-gray-100 pt-6 flex flex-col gap-3">
                    <a href="tel:+5491168674207" className="flex items-center gap-3 text-si-text/50 text-sm hover:text-si-red transition-colors">
                    ...
                    <a href="mailto:solucionesindustrialesns@gmail.com" className="flex items-center gap-3 text-si-text/50 text-sm hover:text-si-red transition-colors">
                        <span className="w-8 h-8 border border-si-red/20 flex items-center justify-center flex-shrink-0">
